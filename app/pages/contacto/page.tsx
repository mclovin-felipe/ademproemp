...
const Page = () => {
  ...
  return (
    <main className={"pb-14"}>
      ...
      {loading && (
        <div className="flex flex-col justify-center  animate-fadeIn items-center animation-FadeIn mt-14 w-4/6 mx-auto gap-10 rounded-2xl bg-gray-50 p-14">
      ...
      {!loading && (
        <div className="grid grid-cols-2 mt-14 w-4/6 mx-auto gap-10 rounded-2xl bg-gray-50 p-14">
